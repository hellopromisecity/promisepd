...
import TransactionsExplorer, { type Row } from "../investments/transactions/TransactionsExplorer";

export const dynamic = "force-dynamic";

export const metadata = { title: "Transactionify", robots: { index: false } };
...
export default async function TransactionifyPage() {
  ...
  if (!admin) {
    return (
      <div className="space-y-6">
        <PageHeader title="Transactionify" subtitle="Every deposit, profit and withdrawal — all in one place." />
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Transactionify" subtitle={`${all.length.toLocaleString("en-US")} transactions — every deposit, profit and withdrawal across the platform.`} />
