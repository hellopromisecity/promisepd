...
export const PROJECTS: Project[] = [
  {
    ...
    price: "৳ ৬ লাখ / শতাংশ",
    description:
      "ঢাকার বুকে পরিকল্পিত আবাসিক টাউনশিপ — ফুজালা টাওয়ার ও ফুজালা কমপ্লেক্সের পাশাপাশি বিনিয়োগযোগ্য জমির প্লট (৪/৬/৯ কাঠা)।",
    longDescription:
    ...
    details: [
      ...
      "জমির মূল্য: প্রতি শতাংশ ৬ লাখ টাকা, প্রতি কাঠা (= ১.৫ শতাংশ) ৯ লাখ টাকা। ৪ কাঠা, ৬ কাঠা ও ৯ কাঠা — তিন ক্যাটাগরির প্লট পাওয়া যাচ্ছে।",
      "যাচাইকৃত দলিল, নামজারিসহ হস্তান্তর — সম্পূর্ণ আইনি নিরাপত্তা। প্লটের লেআউট প্ল্যান দেখে আপনার পছন্দের প্লট বেছে নিন।",
    ],
    highlights: ["৪ / ৬ / ৯ কাঠা প্লট", "প্রতি কাঠা ৯ লাখ টাকা", "যাচাইকৃত দলিল ও নামজারি", "প্রিমিয়াম লোকেশন"],
    accent: "red",
    ...
    plots: {
      ...
      note: "শীঘ্রই: ড্যাশবোর্ড থেকে লাইভ প্লট availability — ৪ / ৬ / ৯ কাঠা ফিল্টার করে কোন প্লট খালি আর কোনটি বিক্রি, তা সবাই দেখতে পারবেন — ইন শা আল্লাহ।",
      categories: [
        { katha: "৪ কাঠা", shotangsho: "৬ শতাংশ", price: "৳ ৩৬ লাখ" },
        { katha: "৬ কাঠা", shotangsho: "৯ শতাংশ", price: "৳ ৫৪ লাখ" },
        { katha: "৯ কাঠা", shotangsho: "১৩.৫ শতাংশ", price: "৳ ৮১ লাখ" },
      ],
    },
  },
  {
