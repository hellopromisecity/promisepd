...
export const TEAM_EN = {
  ...
  bios: {
    ...
    "tarek-ahmed": "Alongside online marketing management, he provides all-round support in the manager's daily operations — handling client communication and work coordination. Directly assisting with the manager's key duties, overseeing the office's routine work, and handling important matters with skill, he is a dependable associate in the company's day-to-day operations.",
