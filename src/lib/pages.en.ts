...
export const POLICY_EN = {
  ...
  rules: [
    ...
    { title: "Promise City May Not Be Presented as Your Own Company", body: "When selling a flat, plot, or any other product, you may not promote Promise City as your own company. Promise is a sole proprietorship, and its one and only owner is the MD & CEO — Md. Kamrul Hasan." },
