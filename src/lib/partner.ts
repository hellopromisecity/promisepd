...
export const MARKETING_POLICY: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "ফ্ল্যাট, জমি বা অন্য যেকোনো পণ্য বিক্রির সময় প্রমিস সিটিকে নিজের কোম্পানি বলে প্রচার করা যাবে না। কারণ প্রমিস একটি একক মালিকানাধীন প্রতিষ্ঠান, এবং এর একমাত্র মালিক MD & CEO — মো. কামরুল হাসান।",
  },
  {
