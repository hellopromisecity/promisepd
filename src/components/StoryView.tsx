            ...
            {isEn ? (
              ...
              <>
                ...
                <p>
                  ...
                  গহনা বিক্রির টাকা — এক টুকরো নিজের ঠিকানার আশায় তাঁরই হাতে আমানত
                  রেখেছেন। সমাজের নানা শ্রেণি-পেশা, নানা প্রান্তের হাজারো মানুষের
                  আস্থা আর ভালোবাসার এই একটিই নাম — যে নামের সাথে মিশে আছে{" "}
                  <span className="font-bold text-fg">
                    বিশ্বাস, সততা ও হাজারো পূরণ হওয়া স্বপ্ন
                  </span>
                  ।
                </p>
              </>
